...
var getUsersGoogleData = function (code) { return __awaiter(void 0, void 0, void 0, function () {
    var tokens, data, userData, err_1;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 3, , 4]);
                return [4 /*yield*/, exports.oauth2Client.getToken(code)];
            case 1:
                tokens = (_a.sent()).tokens;
                exports.oauth2Client.setCredentials(tokens);
                data = googleapis_1.google.oauth2({
                    version: "v2"
                });
                return [4 /*yield*/, data.userinfo.get()];
            case 2:
                userData = _a.sent();
                return [2 /*return*/, {
