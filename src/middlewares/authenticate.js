    ...
    return __generator(this, function (_b) {
        switch (_b.label) {
            case 0:
                ...
                return [4 /*yield*/, Session_1.AuthSession.findSession(req.signedCookies.sid)];
            case 1:
                session = _b.sent();
                ...
                return [4 /*yield*/, Session_1.AuthSession.deleteSession(req.signedCookies.sid)];
            case 2:
                _b.sent();
                res.clearCookie("sid", {
                    httpOnly: true,
            ...
            case 3:
                ...
                res.locals.isBackButtonAvailable =
                    req.originalUrl.split("/").filter(function (url) { return url; }).length >= 2;
                req.user = session.user;
                next();
                return [3 /*break*/, 5];
            case 4:
                err_1 = _b.sent();
                console.log(err_1, "err in middleware");
                return [3 /*break*/, 5];
